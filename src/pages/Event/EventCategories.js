...
const EventCategories = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setAlertMsg({ type: "success", message: "Event Category added successfully!" });
            toggleModal();
            fetchCategories();
        } catch (error) {
            ...
            <Container fluid>
                <Row className="mb-3">
                    <Col className="d-flex justify-content-between align-items-center">
                        <h4></h4>
                        <Button color="primary" onClick={toggleModal}>Add Event Category</Button>
                    </Col>
                </Row>
                ...
                <Modal isOpen={modalOpen} toggle={toggleModal}>
                    <ModalHeader toggle={toggleModal}>Add Event Category</ModalHeader>
                    <ModalBody>
