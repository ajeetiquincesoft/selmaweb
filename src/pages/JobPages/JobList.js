...
const JobList = () => {
  ...
  const fetchJobdata = async (page = 1, filters = {}) => {
    try {
      ...
      const response = await axios.get(`${BASE_URL}/auth/getalljobs`, {
        headers: { Authorization: `Bearer ${token}` },
        params: params,
      });
    ...
    <div className="page-content">
      <Container fluid>
              ...
              <li className={`page-item ${currentPage === 1 ? 'disabled' : ''}`}>
                <button
                  ...
                  onClick={() => {
                    ...
                    fetchJobdata(currentPage - 1, filters);
                  }}
                >
                  &laquo;
                </button>
        ...
        <Modal isOpen={modal} toggle={toggleModal} size="lg">
          <ModalHeader toggle={toggleModal}>Add Job</ModalHeader>
          <ModalBody>
                  ...
                  <Col>
                    ...
                    <Col lg={12} className="mt-3">
                      ...
                      <input
                        ...
                        onChange={handleChange}
                      />
                      {errors.apply_link && <span className="text-danger">{errors.apply_link}</span>}
                    </Col>
